    ...
    <Switch>
      <Route exact path={"/"}>
        <div className="header__authorization-container">
          <p className="header__authorization-container_email_style">{props.email}</p>
          <Link className="header__authorization-link header__authorization-container_link_style" to={"#"}>Выйти</Link>
        </div>
      </Route>
      <Route path={"/signin"}>
